...
class ConvBlock(nn.Module):
    def __init__(self, in_channels, out_channels, discriminator=False, use_activation=False, use_batchnorm=True, **kwargs):
...
class Generator(nn.Module):
    def __init__(self, in_channels=3, num_channels=64, num_blocks=16):
        ...
        self.convblock = ConvBlock(num_channels, num_channels, kernels_size=3, stride=1, padding=1, use_activation=False)
